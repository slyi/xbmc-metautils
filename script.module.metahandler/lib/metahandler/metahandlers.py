...
class MetaData:  
    ...
    def _cache_lookup_episode(self, imdb_id, tvdb_id, season, episode):
        ...
        sqlQuery         = str('SELECT '
                           ...
                           'episode_meta.imdb_id = "%s" AND episode_meta.tvdb_id = coalesce(%s, episode_meta.tvdb_id) AND season = %s AND episode_meta.episode = %s ' % (imdb_id, tvdb_id, season, episode) )
